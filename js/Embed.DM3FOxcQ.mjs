import{t as e}from"./rolldown-runtime.BiHUmXkE.mjs";import{B as t,C as n,F as r,N as i,O as a,R as o,c as s,o as c}from"./react.D7A-7F_q.mjs";import{B as l,F as u,rt as d,s as f}from"./framer.B1PV9JIW.mjs";import{g as p,m,o as h}from"./default-utils.js@_0.45.FGWKmqq6.mjs";import{t as g}from"./default-utils.BgSo9TpQ.mjs";var _,v=e((()=>{d(),_=l({title:`Logo Gradient`,heightmapSource:`image`,mouse:`enabledByDefault`,fragment:`
// === CONSTANTS ===
...
`,propertyControls:{image:{type:f.ResponsiveImage,title:`Image`,defaultValue:`data:framer/asset-reference,7XHsXmlUUmdQM95fkSvi3LRCuSk.svg?originalFilename=Path.svg&width=32&height=48`},colors:{type:f.Array,title:`Colors`,control:{type:f.Color},maxCount:8,defaultValue:[`#000000`,`#0051FF`,`#0DAAFF`,`#BDE4FF`]},colorBack:{type:f.Color,title:`Background`,defaultValue:`#000000`},seed:{type:f.Number,title:`Seed`,defaultValue:6,min:0,max:1e3,step:1,section:`Motion`},speed:{type:f.Number,title:`Speed`,defaultValue:.6,min:0,max:2,step:.01,section:`Motion`},motionMode:{type:f.Enum,title:`Motion`,options:[0,1],optionTitles:[`Random`,`Directional`],defaultValue:0,section:`Motion`},angle:{type:f.Number,title:`Angle`,defaultValue:20,min:0,max:360,step:1,section:`Motion`},scale:{type:f.Number,title:`Scale`,defaultValue:1.2,min:.1,max:2,step:.01,section:`Motion`},turbAmp:{type:f.Number,title:`Amplitude`,defaultValue:.21,min:0,max:1,step:.01,section:`Motion`},turbFreq:{type:f.Number,title:`Frequency`,defaultValue:1.15,min:.1,max:2,step:.01,section:`Motion`},turbIter:{type:f.Number,title:`Definition`,defaultValue:7,min:3,max:8,step:1,displayStepper:!0,section:`Motion`},waveFreq:{type:f.Number,title:`Bands`,defaultValue:2.4,min:.1,max:5,step:.1,section:`Motion`},bend:{type:f.Number,title:`Bevel`,defaultValue:.24,min:0,max:1,step:.01,section:`Shape`,hiddenWhenUnset:!0},contour:{type:f.Number,title:`Contour`,defaultValue:.8,min:0,max:1,step:.1,section:`Shape`,hiddenWhenUnset:!0},pushRadius:{type:f.Number,title:`Radius`,defaultValue:1.5,min:.2,max:4,step:.1,section:`Interaction`},pushAmount:{type:f.Number,title:`Strength`,defaultValue:8,min:0,max:20,step:.5,section:`Interaction`}}})}));function y({type:e,url:t,html:n,zoom:r,radius:i,border:a,style:o={}}){return e===`url`&&t?s(x,{url:t,zoom:r,radius:i,border:a,style:o}):e===`html`&&n?s(C,{html:n,style:o}):s(b,{style:o})}function b({style:e}){return s(`div`,{style:{minHeight:A(e),...p,overflow:`hidden`,...e},children:s(`div`,{style:N,children:`To embed a website or widget, add it to the properties\xA0panel.`})})}function x({url:e,zoom:t,radius:n,border:a,style:o}){let c=!o.height;/[a-z]+:\/\//.test(e)||(e=`https://`+e);let l=h(),[u,d]=r(l?void 0:!1);return i(()=>{if(!l)return;let t=!0;d(void 0);async function n(){let n=await fetch(`https://api.framer.com/functions/check-iframe-url?url=`+encodeURIComponent(e));if(n.status==200){let{isBlocked:e}=await n.json();t&&d(e)}else{let e=await n.text();console.error(e),d(Error(`This site can’t be reached.`))}}return n().catch(e=>{console.error(e),d(e)}),()=>{t=!1}},[e]),l&&c?s(k,{message:`URL embeds do not support auto height.`,style:o}):e.startsWith(`https://`)?u===void 0?s(O,{}):u instanceof Error?s(k,{message:u.message,style:o}):u===!0?s(k,{message:`Can’t embed ${e} due to its content security policy.`,style:o}):s(`iframe`,{src:e,style:{...j,...o,...a,zoom:t,borderRadius:n,transformOrigin:`top center`},loading:`lazy`,fetchPriority:l?`low`:`auto`,referrerPolicy:`no-referrer`,sandbox:S(l),allowFullScreen:!0,allow:`presentation; fullscreen; accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; clipboard-write`}):s(k,{message:`Unsupported protocol.`,style:o})}function S(e){let t=[`allow-same-origin`,`allow-scripts`];return e||t.push(`allow-downloads`,`allow-forms`,`allow-modals`,`allow-orientation-lock`,`allow-pointer-lock`,`allow-popups`,`allow-popups-to-escape-sandbox`,`allow-presentation`,`allow-storage-access-by-user-activation`,`allow-top-navigation-by-user-activation`),t.join(` `)}function C({html:e,...t}){if(e.includes(`<\/script>`)){let n=e.includes(`</spline-viewer>`),r=e.includes(`<!-- framer-direct-embed -->`);return s(n||r?T:w,{html:e,...t})}return s(E,{html:e,...t})}function w({html:e,style:n}){let o=a(),[c,l]=r(0);i(()=>{let e=o.current?.contentWindow;function n(t){if(t.source!==e)return;let n=t.data;if(typeof n!=`object`||!n)return;let r=n.embedHeight;typeof r==`number`&&l(r)}return t.addEventListener(`message`,n),e?.postMessage(`getEmbedHeight`,`*`),()=>{t.removeEventListener(`message`,n)}},[]);let u=`
<html>
    <head>
        <style>
            html, body {
...
`,d={...j,...n};return n.height||(d.height=c+`px`),s(`iframe`,{ref:o,style:d,srcDoc:u})}function T({html:e,style:t}){let n=a();return i(()=>{let t=n.current;if(t)return t.innerHTML=e,D(t),()=>{t.innerHTML=``}},[e]),s(`div`,{ref:n,style:{...M,...t}})}function E({html:e,style:t}){return s(`div`,{style:{...M,...t},dangerouslySetInnerHTML:{__html:e}})}function D(e){if(e instanceof Element&&e.tagName===`SCRIPT`){let t=document.createElement(`script`);t.text=e.innerHTML;for(let{name:n,value:r}of e.attributes)t.setAttribute(n,r);e.parentElement.replaceChild(t,e)}else for(let t of e.childNodes)D(t)}function O(){return s(`div`,{className:`framerInternalUI-componentPlaceholder`,style:{...m,overflow:`hidden`},children:s(`div`,{style:N,children:`Loading…`})})}function k({message:e,style:t}){return s(`div`,{className:`framerInternalUI-errorPlaceholder`,style:{minHeight:A(t),...m,overflow:`hidden`,...t},children:s(`div`,{style:N,children:e})})}function A(e){if(!e.height)return 200}var j,M,N,P=e((()=>{o(),c(),n(),d(),g(),u(y,{type:{type:f.Enum,defaultValue:`url`,displaySegmentedControl:!0,options:[`url`,`html`],optionTitles:[`URL`,`HTML`]},url:{title:`URL`,type:f.String,description:`Some websites don’t support embedding.`,hidden(e){return e.type!==`url`}},html:{title:`HTML`,type:f.String,displayTextArea:!0,hidden(e){return e.type!==`html`}},border:{title:`Border`,type:f.Border,optional:!0,hidden(e){return e.type!==`url`}},radius:{type:f.BorderRadius,title:`Radius`,hidden(e){return e.type!==`url`}},zoom:{title:`Zoom`,defaultValue:1,type:f.Number,hidden(e){return e.type!==`url`},min:.1,max:1,step:.1,displayStepper:!0}}),j={width:`100%`,height:`100%`,border:`none`},M={width:`100%`,height:`100%`,display:`flex`,flexDirection:`column`,justifyContent:`center`,alignItems:`center`},N={textAlign:`center`,minWidth:140}}));export{v as i,P as n,_ as r,y as t};
//# sourceMappingURL=Embed.DM3FOxcQ.mjs.map